...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- <link rel="icon" type="image/png" href="../assets/img/vsuihs-logo.png"> -->
    ...
    <div id="app">
        ...
        @section('content')
        <div class="relative flex items-top justify-center bg-white dark:bg-gray-900 sm:items-center mt-8"> 
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            
                <h2 class="text-center" style="font-size:30px; background:#05300e; color:#fff; font-weight:bold; text-align:center; padding:15px;">Visayas State University - Integrated High School</h2>
                ...
                <div class="row mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="col-lg-6 col-md-12 col-sm-12 ml-auto">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Relevance, Integrity, Truth, Excellence
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 ml-auto">
                        <div class="p-6 border-gray-200 dark:border-gray-700">
                            <h5 class="p-6">New Student Registration</h5>
                            <form method="POST" action="{{ route('register') }}">
                                @csrf
                                <div class="row mb-3">
                                    <label for="studentnumber" class="col-md-4 col-form-label text-md-end">{{ __('Student Number') }}</label>

                                    <div class="col-md-6">
                                        <input id="studentnumber" type="text" class="form-control @error('firstname') is-invalid @enderror" name="studentnumber" value="{{ old('studentnumber') }}" required autocomplete="studentnumber" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="birthdate" type="date" class="form-control" name="birthdate" required autocomplete="birthdate">
                                    </div>
                                </div>
