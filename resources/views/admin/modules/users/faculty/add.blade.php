                ...
                <div class="row align-items-center">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.faculty-user')}}">Faculty</a></li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <form action="{{route('admin.faculty-user-create')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Faculty Information
                                        </h5>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control @error('university_number') is-invalid @enderror" onKeyPress="if(this.value.length==12) return false;" type="number" name="university_number" placeholder="Enter University Number" value="{{ old('university_number') }}">
