                ...
                <div class="profile-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col ms-md-n2 profile-user-info">
                            <h6 class="text-muted">{{ $details->lrn_number }}</h6>
                            <h4 class="user-name mb-0">{{ $details->firstname . ' ' .$details->lastname }}</h4>
                            <h6 class="text-muted">{{ $details->grade_level.' '.$details->section }}</h6>
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-success" type="button"><i class="fe fe-check-verified"></i></button>
                                    </div>
                                </div>
