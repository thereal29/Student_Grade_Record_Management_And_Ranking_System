...
class StudentController extends Controller
{
    public function index(){
        ...
        return view('staff.modules.students.index', compact('advisers'));
    }
    public function fetchStudents(Request $request){
        ...
        if($students->count() > 0){
            ...
            foreach($students as $key=>$student ){
                ...
                <td class="text-end">
                    <div class="actions">
                        <a id="' . $student->sid . '" class="btn btn-sm bg-danger-light student_view" data-bs-toggle="modal" data-bs-target="#studentUser">
    ...
    public function viewProfile(Request $request){
        ...
        return view('staff.modules.students.profile', compact('details', 'numClass'));
    }
    public function viewRecord(Request $request){
        ...
        return view('staff.modules.students.records.view_record', compact('record'));
    }
