    ...
    public function fetchStudentRegistration(Request $request){
        ...
        if($selSY == 'Show All'){
            if($gradelevel != null){
                ...
                $student = StudentUser::select('*','student_personal_details.id as sid', DB::raw('COUNT(student_subject.student_id) AS ctr'))->join('student_gradelevel_section', 'student_gradelevel_section.id', '=', 'student_personal_details.glevel_section_id')->join('student_user_mapping', 'student_user_mapping.student_id', '=', 'student_personal_details.id')->join('users', 'users.id', '=', 'student_user_mapping.user_id')->join('school_year', 'school_year.id', '=', 'users.sy_id')->leftJoin('student_subject', 'student_subject.student_id', '=', 'student_personal_details.id')->groupBy('student_subject.student_id')->get();
            }
        }else{
            if($gradelevel != null){
                $student = StudentUser::select('*','student_personal_details.id as sid', DB::raw('COUNT(student_subject.student_id) AS ctr'))->join('student_gradelevel_section', 'student_gradelevel_section.id', '=', 'student_personal_details.glevel_section_id')->join('student_user_mapping', 'student_user_mapping.student_id', '=', 'student_personal_details.id')->join('users', 'users.id', '=', 'student_user_mapping.user_id')->join('school_year', 'school_year.id', '=', 'users.sy_id')->leftJoin('student_subject', 'student_subject.student_id', '=', 'student_personal_details.id')->where('student_gradelevel_section.grade_level', $gradelevel)->where('school_year.from_year', $selSY)->groupBy('student_subject.student_id')->get();
            }else{
                $student = StudentUser::select('*','student_personal_details.id as sid', DB::raw('COUNT(student_subject.student_id) AS ctr'))->join('student_gradelevel_section', 'student_gradelevel_section.id', '=', 'student_personal_details.glevel_section_id')->join('student_user_mapping', 'student_user_mapping.student_id', '=', 'student_personal_details.id')->join('users', 'users.id', '=', 'student_user_mapping.user_id')->join('school_year', 'school_year.id', '=', 'users.sy_id')->leftJoin('student_subject', 'student_subject.student_id', '=', 'student_personal_details.id')->where('school_year.from_year', $selSY)->groupBy('student_subject.student_id')->get();
            }
        }
